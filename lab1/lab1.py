...
if __name__ == '__main__':
    ...
    df = read_data('data/tasutud_maksud_2019_ii_kvartal_eng.csv')
    ...
    SME = df[df['Number of employees'] < 250]
    print(SME)

    # Extract column 'Number of employees' to variable sme_employees
    sme_employees = SME['Number of employees']
    ...
    sme_df = SME[['Labour taxes and payments', 'Number of employees']].corr()
    ...
    plt.subplot(2, 2, 3)
    plt.scatter(sme_df['Labour taxes and payments'], sme_df['Number of employees'],
                color='red', s=0.5)
